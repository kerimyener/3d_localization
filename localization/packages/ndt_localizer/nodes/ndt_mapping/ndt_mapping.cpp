...
{
  nh.getParam("resolution",ndt_res);
  nh.getParam("step_size",step_size);
  nh.getParam("trans_epsilon",trans_eps);
  nh.getParam("max_iterations",max_iter);
  nh.getParam("leaf_size",voxel_leaf_size);
  nh.getParam("min_scan_range",min_scan_range);
  nh.getParam("min_add_scan_shift",min_add_scan_shift);
  nh.getParam("filter_resolution",filter_res);
